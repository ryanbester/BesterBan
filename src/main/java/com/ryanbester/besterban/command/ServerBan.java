...
public class ServerBan extends Command {
    ...
    public ServerBan(Plugin plugin) {
        super("serverban", "besterban.serverban");
        this.plugin = plugin;
    }
    ...
    public void execute(CommandSender commandSender, String[] strings) {
                ...
                if (player.getName().equals(username)) {
                    ...
                    if (player.getServer().getInfo().equals(serverInfo)) {
                        player.disconnect(BanMessage.getMessage(new BanMessageInfo(
                            "Server", "Permanent", reason, appealID
        ...
        new Thread(() -> {
            try {
                ...
                if (DatabaseHelper
                    .addBan(uuid, null, "Server", server, reason, appealID, bannedBy)
                    == null) {
                    commandSender
